...
import { faBars, faSignOut, faSignIn, faHome, faCubes, faUser, faUsers, faFlaskVial, faMountainCity, faCity, faCopyright, faBoxOpen  } from '@fortawesome/free-solid-svg-icons'
