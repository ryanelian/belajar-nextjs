...
import { BelajarNextJsBackEndClient, Brand, Province } from '@/functions/swagger/BelajarNextJsBackEnd';
...
const BrandTableRow: React.FC<{
    ...
    function onClickDelete() {
        Modal.confirm({
            ...
            content: `Delete province ${brand.name}?`,
            okText: 'Yes',
            okType: 'danger',
            cancelText: 'No',
            async onOk() {
...
const IndexPage: Page = () => {
    ...
    const { data, error, mutate } = useSwr<Province[]>('/api/be/api/Brands', swrFetcher);

    return (
        <div>
            <Title>Manage Brands</Title>
            <h2 className='mb-5 text-3xl'>Manage Brands</h2>
            <div>
