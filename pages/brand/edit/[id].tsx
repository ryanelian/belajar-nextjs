...
const IndexPage: Page = () => {
    ...
    const brandsDetailUri = id ? `/api/be/api/Brands/${id}` : undefined;
    const { data, mutate } = useSwr<Brand>(brandsDetailUri, fetcher);
    ...
    return (
        <div>
            ...
            <h2 className='mb-5 text-3xl'>Edit Brands Data</h2>
            {renderForm()}
        </div>
    );
}
