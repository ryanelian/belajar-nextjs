...
const FormSchema = z.object({
    ...
    price: z.number({invalid_type_error : 'Price tidak boleh kosong' }).gte(1000,{message: 'Price harus lebih besar dari Rp 1000'}).max(999999999,{message: 'Price harus kurang dari Rp 999.999.999'}),
    quantity: z.number({invalid_type_error : 'Quantity tidak boleh kosong' }).gte(1,{message: 'Quantity harus paling tidak dari 1'}).max(1000,{message: 'Quantity tidak boleh melebihi 1000 barang'}),
...
const EditForm: React.FC<{
    ...
    const brandsUri = '/api/be/api/Brand?' + params.toString();
