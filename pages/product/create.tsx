...
const CreatePage: Page = () => {
    ...
    async function onSubmit(data: FormDataType) {
        try {
            ...
            notification.success({
                message: 'Success',
                description: 'Data Product Berhasil Ditambahkan',
    ...
    return (
        <div>
            ...
            <h2 className='mb-5 text-3xl'>Create Product</h2>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='my-2'>
                    ...
                    <InputText type="number" inputMode='decimal' id='quantity' {...register('quantity', { valueAsNumber: true })}></InputText>
                    <p className='text-red-500'>{errors['quantity']?.message}</p>
                </div>
                <div className='my-2'>
                    <label className="font-bold" htmlFor='price'>Price</label>
                    <InputText type="number" inputMode='decimal' id='price' {...register('price', { valueAsNumber: true })}></InputText>
