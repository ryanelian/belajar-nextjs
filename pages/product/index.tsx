...
const IndexPage: Page = () => {
    ...
    return (
        <div>
            ...
            <h2 className='mb-5 text-3xl font-bold text-blue-800'>Manage Products</h2>
            <div>
            ...
            <table className='table-auto mt-5'>
                ...
                <tbody>
                    {data?.map((x, value) => <ProductTableRow key={value} product={x} onDeleted={() => mutate()}></ProductTableRow>)}
                </tbody>
            </table>
        </div>
    );
