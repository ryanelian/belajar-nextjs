...
import { BelajarNextJsBackEndClient, CityDataGridItem, ProductDataGridItem } from '@/functions/swagger/BelajarNextJsBackEnd';
...
const ProductTableRow: React.FC<{
    ...
    function onClickDelete() {
        Modal.confirm({
            ...
            content: `Delete city ${product.name}?`,
            okText: 'Yes',
            okType: 'danger',
            cancelText: 'No',
            async onOk() {
    ...
    return (
        <tr>
            ...
            <td className="border px-4 py-2">{FormatPrice()}</td>
...
const IndexPage: Page = () => {
    ...
    const { data, error, mutate } = useSwr<CityDataGridItem[]>('/api/be/api/Products', swrFetcher);
